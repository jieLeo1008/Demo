package com.example.jieleo.customviewdemo.wheel;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.mipmap.ic_launcher_round;
	private int wheelForeground = R.mipmap.ic_launcher_round;
	// Shadows drawables
	...
	public void notifyChangingListeners() {
		for (OnWheelChangedListener listener : changingListeners) {
			listener.onChanged(this, 0, 0);
		}
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		setWheelBackground(R.color.colorWhite);
	}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.preview_bottom_size));
		// 设置线宽
