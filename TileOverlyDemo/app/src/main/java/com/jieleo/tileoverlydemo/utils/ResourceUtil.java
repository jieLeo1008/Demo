...
public class ResourceUtil {
    ...
    public static final Drawable getDrawable(int resid) {
        return MyApp.getContext().getResources().getDrawable(resid);
    }
    ...
    public static final int getDimens(int resid) {
        return (int) MyApp.getContext().getResources().getDimension(resid);
    }
    ...
    public static final String[] getStringArray(int resid) {
        return MyApp.getContext().getResources().getStringArray(resid);
    }
    ...
    public static final int getInteger(int resid) {
        return MyApp.getContext().getResources().getInteger(resid);
    }
    ...
    public static final int getDrawableResId(String name) {
        return MyApp.getContext().getResources().getIdentifier(name, "drawable", MyApp.getContext().getPackageName());
    }
