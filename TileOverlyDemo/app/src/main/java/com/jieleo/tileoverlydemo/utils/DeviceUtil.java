...
public class DeviceUtil {
    ...
    public static int getStatusHeightNew() {
        ...
        try {
            ...
            sbar = MyApp.getContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static boolean isSimulator() {
        try {
            // 判断imei是否非法
            TelephonyManager tm = (TelephonyManager) MyApp.getContext().getSystemService(Context.TELEPHONY_SERVICE);
