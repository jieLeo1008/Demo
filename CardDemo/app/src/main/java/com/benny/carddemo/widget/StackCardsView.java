...
public class StackCardsView extends FrameLayout {
     ...
     * 任意方向滑动
     */
    public static final int SWIPE_ALL = SWIPE_DOWN | SWIPE_RIGHT | SWIPE_UP | SWIPE_DOWN;
...
//                .swipeDirection(adapter.getSwipeDirection(position))
                .swipeDirection(SWIPE_DOWN|SWIPE_UP)
//                .dismissDirection(adapter.getDismissDirection(position))
                .dismissDirection(SWIPE_DOWN|SWIPE_UP)
